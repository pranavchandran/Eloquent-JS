...
What we’re interested in is the destinations that we can 
reach from a given place. Let’s convert the list of roads 
to a data structure that, for each place, tells us what 
can be reached from there.
*/
/*
Making Robot-
    understading exercises
    Map
    for(let x of ['pranav','lol-op','python','django'].map(r=>r.split("-"))){
    console.log(x)
}
    includes
...
// Robot making function time study 
function randomPick(array){
    let choice = Math.floor(Math.random()*array.length);
    return array[choice]
}
// console.log(randompick([1,2,3,4]))
